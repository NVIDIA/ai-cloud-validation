...
.146+| Infrastructure and Data Services
...
.47+| SDN Controller
.37+| Controls software-defined networking overlays and fabric behavior to match the compute-on-demand requirements. Enables network segmentation, isolation, dynamic network configuration, and security groups.
.37+|
| [[SDN01-01]]SDN01-01
| SDN01
...
| [[K8S24-01]]K8S24-01
| K8S24
| https://github.com/NVIDIA/ai-cloud-validation/issues/662[#662]
| gpu, kubernetes, min_req
| tenant
| k8s06/22
| P0
a| https://github.com/NVIDIA/ai-cloud-validation/issues/662[#662]
|
|
|
...
| [[K8S02-01]]K8S02-01
| K8S02
| https://github.com/NVIDIA/ai-cloud-validation/issues/659[#659]
| kubernetes, min_req
| tenant
|
| INFO
a| https://github.com/NVIDIA/ai-cloud-validation/issues/659[#659]
|
| M5
|
...
| kubernetes, min_req
| operator
| Downtime during control plane updates is covered by K8S09-01.
| INFO
a| https://github.com/NVIDIA/ai-cloud-validation/issues/659[#659]
|
| M5
|
| Verify control plane security patching is automated and keeps the control plane on a current upstream patch
| pending
|
