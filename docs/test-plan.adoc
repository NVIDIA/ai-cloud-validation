...
.46+| Managed Kubernetes Control Plane
...
| operator
| One l8k validate invocation consumes a complete user config and rendered deployment directory; topology, deployment readiness, and selected connectivity families are prerequisites
| P0
a|
| LimitedEnv
|
|
| Run the Launch Kit connectivity matrix against an ISV-provisioned Network Operator deployment
| pending
|
