...
| **Observability** | [`providers/aws/config/observability.yaml`](../../isvctl/configs/providers/aws/config/observability.yaml) | [`providers/aws/scripts/observability/`](../../isvctl/configs/providers/aws/scripts/observability/) | - | [`suites/observability.yaml`](../../isvctl/configs/suites/observability.yaml) |
