...
| `block-storage/` | 5 | [`suites/storage.yaml`](../../../suites/storage.yaml) | [`config/block-storage.yaml`](../config/block-storage.yaml) | [`providers/aws/scripts/block-storage/`](../../aws/scripts/block-storage/) |
